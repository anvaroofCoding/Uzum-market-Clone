					...
					<div className='theme-switch__stars-container'>
						...
						>
							<path
								fillRule='evenodd'
								clipRule='evenodd'
								d='...' // 👈 SVG qisqartirildi, sizdagi kod qoladi
								fill='currentColor'
							/>
						</svg>
					</div>
...
const StyledWrapper = styled.div`
	.theme-switch {
		--toggle-size: 20px; /* ⬅️ Asosiy o‘lchamni kichik qildik */
		--container-width: 3.75em; /* oldingi 5.625em */
		--container-height: 1.65em; /* oldingi 2.5em */
		--container-radius: 4.125em; /* oldingi 6.25em */
		--circle-container-diameter: 2.25em; /* oldingi 3.375em */
		--sun-moon-diameter: 1.4em; /* oldingi 2.125em */
		--sun-bg: #ecca2f;
		--moon-bg: #c4c9d1;
		--spot-color: #959db1;
